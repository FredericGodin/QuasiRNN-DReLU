...
parser.add_argument("--settings_name", type=str,required=True,help="Settings file of the format lm_settings_DATE")
parser.add_argument("--model_folder", type=str,default="../models/word_language_modeling/",help="Model folder containing the settings file")
...
print("Test perplexity: %s " % (perplexity_test))
